...
: ${AMENT_CURRENT_PREFIX:="/home/yiyi/ackermann_sim/install/saye_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/saye_description/environment/ros_gz_example_description.sh"
