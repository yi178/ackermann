...
class Metaclass_ShareMap_Event(type):
    """Metaclass of message 'ShareMap_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__share_map__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__share_map__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__share_map__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__share_map__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__share_map__event
...
class ShareMap_Event(metaclass=Metaclass_ShareMap_Event):
    """Message class 'ShareMap_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<saye_msgs/ShareMap_Request, 1>',
        'response': 'sequence<saye_msgs/ShareMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['saye_msgs', 'srv'], 'ShareMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['saye_msgs', 'srv'], 'ShareMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from saye_msgs.srv import ShareMap_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ShareMap_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ShareMap_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from saye_msgs.srv import ShareMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ShareMap_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ShareMap_Response'"
...
class Metaclass_ShareMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _share_map.Metaclass_ShareMap_Event._TYPE_SUPPORT is None:
                _share_map.Metaclass_ShareMap_Event.__import_type_support__()
...
class ShareMap(metaclass=Metaclass_ShareMap):
    ...
    from saye_msgs.srv._share_map import ShareMap_Event as Event
